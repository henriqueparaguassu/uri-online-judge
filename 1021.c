...
int main()
{
  ...
  if (N >= 0.25)
  {
    moedas25 = (N - (notas100 * 100) - (notas50 * 50) - (notas20 * 20) - (notas10 * 10) -
                (notas5 * 5) - (notas2 * 2) - (notas1 * 1) - (moedas50 * 0.50)) /
               0.25;
  }
  ...
  if (N >= 0.05)
  {
    moedas5 = (N - (notas100 * 100) - (notas50 * 50) - (notas20 * 20) - (notas10 * 10) -
               (notas5 * 5) - (notas2 * 2) - (notas1 * 1) - (moedas50 * 0.50) - (moedas25 * 0.25) - (moedas10 * 0.10)) /
              0.05;
  }
